...
/// <summary>
/// Управление панелями для игры Bubbles Math
/// Автоматически настраивает локализацию для всех панелей
/// </summary>
public class GamePanelManager : MonoBehaviour
{
    ...
    private void SetupPanels()
    {
        ...
        {
            panelDictionary["SettingsPanel"] = new PanelData
            {
                panelName = "SettingsPanel",
                panelObject = settingsPanel,
                updateLocalizationOnShow = true,
                updateLocalizationOnHide = false
            };
        }
    ...
    {
        GameObject[] panels = { menuPanel, gamePanel, tutorialPanel, settingsPanel, leaderboardPanel, pausePanel, continueGamePanel };
